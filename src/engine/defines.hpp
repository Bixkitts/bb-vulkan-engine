...
#define MAX_FRAMES_IN_FLIGHT         2  // Amount of frame buffers on the swap chain TODO: make this dynamic?
#define SWAPCHAIN_MAX_DEPTH_IMAGES   4
#define SWAPCHAIN_MAX_IMAGES         4 // Still don't know what swap chain images are
#endif
