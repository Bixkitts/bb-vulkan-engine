...
namespace bve
{
            ...
            PipelineConfigInfo* configInfo)
    {
        ...
        BveGraphicsPipeline *mainPipeline = new BveGraphicsPipeline{};
        mainPipeline->myPipelineDevice = device;

        createShaderModule(device, vertCode, &mainPipeline->vertShaderModule);
        createShaderModule(device, fragCode, &mainPipeline->fragShaderModule);
